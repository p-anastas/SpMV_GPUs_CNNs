...
src = '/local/panastas/training_suite/' # '/home/users/panastas/Mine/training_suite/'
check = '/local/panastas/Div_suite/'
if len (sys.argv) != 3:
		...
		if status.st_size > 1024*1024*500:
			...
			if sparse.issparse(A):
				...
				if sz < 50000:
					...
					dest =  '/local/panastas/Div_suite/' # '/home/users/panastas/Mine/python_pic/Outs/'
					name = in_file
					C = dg_dist(A, divz)
