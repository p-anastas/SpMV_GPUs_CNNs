...
deploy_list = [ '../Train_files/Arch/caffenet/deploy.prototxt',  '../Train_files/Arch/caffenet/deploy_256.prototxt', '../Train_files/Arch/caffenet/deploy_256.prototxt']
...
caffe.set_mode_gpu()
models = [ '../Solverstates/DDVT_dataset_binary/Binary_NM_Caffenet_iter_5468.caffemodel', '../Solverstates/Small_dataset_Density/Density_Caffenet_iter_20000.caffemodel', '../Solverstates/Total_dataset_binary/Density_Caffenet_iter_25570.caffemodel' ] # Nomean 120000, Mean 120000,420000  ['../Solverstates/Googlenet_iter_10000.caffemodel']
model_type = [0,1,1]
mulist =   [np.array([0,0,0]), np.array([34.4794,10.3774,1.44179]), np.array([40.1584,12.0457,4.6718])]
#mulist = [ np.array([0,0,0]), np.array([238.238,230.556,216.178]),  np.array([241.473,235.017,223.23]), np.array([34.4794,10.3774,1.44179]), np.array([40.1584,12.0457,4.6718]), np.array([30.1884,10.4965,3.14379]) ]
